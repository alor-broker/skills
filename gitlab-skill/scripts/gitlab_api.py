...
class GitLabAPI:
    ...
    def __init__(self, config_path: Optional[Path] = None, insecure: bool = False,
        ...
        Args:
            config_path: [DEPRECATED] Path to config.json file. Use environment variables or ~/.veles/gitlab_config.json instead.
        ...
        if config_path is not None:
            ...
            print("   user config file (~/.veles/gitlab_config.json)")
    ...
    def _make_request(self, endpoint: str, method: str = "GET", data: Optional[Dict] = None, use_curl: bool = False) -> Dict:
        ...
        try:
            ...
            if self.host.startswith("https://"):
                print(
                    "Hint: if this internal GitLab is reachable only over HTTP, "
                    "set GITLAB_HOST to the http:// URL. The helper does not "
                    "automatically downgrade HTTPS connections."
                )
            sys.exit(1)
